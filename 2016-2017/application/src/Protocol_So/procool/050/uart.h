...
#define SUB_VERSION 1  //用户版本号 目前为1
...
//类型代码	说明	方向
//0	预留	
#define  DEVICE_STATE        1 //1	上传火灾自动报警系统设备状态	上行Device state
#define  PARTS_RUNNING_STATE 2//2	上传火灾自动报警系统部件运行状态	上行 Parts running state
#define  ANALOG_VALUE        3//3	上传火灾自动报警系统部件模拟量值	上行 Analog
#define  DEVICE_OPER_INFO    4//4	上传火灾自动报警系统设备操作信息	上行
